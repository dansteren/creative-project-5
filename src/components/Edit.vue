  ...
  <div class="add-component">
    ...
    <div class="page">
      <form>
        ...
        <textarea tabIndex='4' v-model="psmessage" placeholder="Add an additional message (optional)"/>
        <div class="error">{{error}}</div>
        <div class="buttons">
          <button tabIndex='1' class="back-button" @click.prevent="goToDashboard">Done</button>
          <button tabIndex='5' class="submit-button" @click.prevent="updateCard">Update Gift</button>
        </div>
      </form>
    </div>
  </div>
